...
def main():
    ...
    uf_x265 = uf_since.clone(
        ...
        cl_args='--preset ultrafast --tune ssim --me 1 --ref 2 --limit-refs 3 --signhide --b-intra --threads 12'
    )
    ...
    vs_x265 = vs_since.clone(
        ...
        encoder_type=X265,
        encoder_revision="3.0",
        cl_args='--preset veryslow --tune ssim --limit-refs 1 --limit-modes --max-merge 4 --aq-mode 1 --limit-tu 4 --threads 12'
    )
