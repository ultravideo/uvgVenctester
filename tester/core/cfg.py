...
class Cfg(metaclass=Singleton):
    ...
    csv_field_names: dict = {
        ...
        csv.CsvField.SPEEDUP: "Average Speedup",
        csv.CsvField.ITEM_WISE_SPEEDUP: "Speedup",
        ...
        csv.CsvField.BD_PSNR: "BD-PSNR",
        csv.CsvField.BD_SSIM: "BD-SSIM",
        csv.CsvField.BD_VMAF: "BD-VMAF",
    ...
    graph_include_bitrate_targets = True
